...
function renderDonutChart(completed, pending, overdue, total) {
  ...
  container.innerHTML = `
    ...
    <div class="chart-center-text">
      <div style="font-size: 1.8rem; font-weight: 800; font-family: var(--font-mono); color: var(--cyan-bright);">${total}</div>
      <div style="font-size: 0.72rem; text-transform: uppercase; color: var(--text-muted); letter-spacing: 0.05em;">Total Tasks</div>
    </div>
  `;
}
